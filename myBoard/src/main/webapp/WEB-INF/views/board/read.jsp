...
<div class="container">
	...
	<section>
		<form  role="form" method="post" autocomplete="off">
			<input type="hidden" id="page" name="page" value="${scri.page}" disabled="disabled" />
			<input type="hidden" id="perPageNum" name="perPageNum" value="${scri.perPageNum}" disabled="disabled" />
			<input type="hidden" id="searchType" name="searchType" value="${scri.searchType}" disabled="disabled" />
			<input type="hidden" id="keyword" name="keyword" value="${scri.keyword}" disabled="disabled" />
			<div class="form-group">
				<label for="bno" class="col-sm-2 control-label">글 번호</label>
				<div class="col-sm-10">
					<input type="text" id="bno" name="bno" class="form-control" value="${read.bno}" disabled="disabled"/>
				</div>
			</div>
		</form>
			<div class="form-group"> 
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea id="content" name="content" class="form-control" disabled="disabled" >${read.content}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label for="writer"class="col-sm-2 control-label">작성자</label>
				<div class="col-sm-10">
					<input type="text" id="writer" name="writer" class="form-control" value="${read.writer}" disabled="disabled" />
				</div>
			</div>
			<div class="form-group">
